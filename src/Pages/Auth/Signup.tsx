        ...
        <div className="py-16 w-full">
          <div className="w-full flex flex-col items-center">
            ...
            <div className="mt-1 text-black/60">
              Creating an account is now free
            </div>
            ...
            <div className="w-5/12">
              ...
              <div className="rounded-md flex my-2 border border-black/90 w-full items-center h-14 justify-center text-black font-bold text-lg px-4">
                <div className="text-black/70">ninebug.com/@</div>
                <input
                  type="text"
                  value={userName}
                  placeholder="username"
                  className="w-3/4 h-full bg-transparent outline-none"
                  onChange={async (e) => {
                    setUserName(e.target.value.split(" ").join("_"));
                  }}
                />
              </div>
              {loading ? (
